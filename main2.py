...
from queries.chatbot import render_chatbot
...
tab1, tab2, tab3, tab4, tab5 = st.tabs(["**📋 EPC Alerts**", "**📋 EPI Alerts**", "**📈 Partner Volume Spike Tracker**", "**📈 Category Volume Spike Tracker**", "**🧠 ChatBot**"])
